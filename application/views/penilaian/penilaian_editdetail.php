                                  ...
                                  <tr> 
                                    ...
                                    <td width="5%">
                                      <?php 
                                        ...
                                        if($checked>0){
                                          ?>
                                            <input required onchange="ganti(<?php echo $lsd['nilai_aktual'] ?>,<?php echo $l['id_kriteria']?>,<?php echo $ls['id_subkriteria'] ?>)" checked class="radio_<?php echo $l['id_kriteria'].'_'.$ls['id_subkriteria']?>" name="radiochecked_1_<?php echo $l['id_kriteria'].'_'.$ls['id_subkriteria'] ?>" type="radio" value="<?php echo $lsd['id_subkriteriadetail'] ?>"> 
                                          <?php
                                        }else{
                                          ?>
                                            <input required onchange="ganti(<?php echo $lsd['nilai_aktual'] ?>,<?php echo $l['id_kriteria']?>,<?php echo $ls['id_subkriteria'] ?>)" class="radio_<?php echo $l['id_kriteria'].'_'.$ls['id_subkriteria']?>" name="radiochecked_1_<?php echo $l['id_kriteria'].'_'.$ls['id_subkriteria'] ?>" type="radio" value="<?php echo $lsd['id_subkriteriadetail'] ?>"> 
                                          <?php
                                        }
                                      ?>
                                     </td> 
