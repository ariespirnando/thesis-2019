    ...
    <tbody>
      ...
      if($aturandetailnum>0){
        ...
        <tr> 
              ...
              <?php 
                foreach ($subkriteria as $ad) {
                  if($ad['id_subkriteria']==$adt['id_subkriteria']){
                    echo '<option selected value="'.$ad['id_subkriteria'].'">['.$ad['kode_subkriteria'].'] '.$ad['keterangan'].'</option>';
                  }else{
          ...
          <td style="width:5%;">  
            <input type="text" class="form-control angka2" required name='nilai[]' placeholder="Nilai" value="<?php echo $adt['nilai'] ?>"> 
          </td> 
          <td style="width:5%;">  
