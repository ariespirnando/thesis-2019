...
DELETE FROM `master_aturan`;
/*!40000 ALTER TABLE `master_aturan` DISABLE KEYS */;
INSERT INTO `master_aturan` (`id_aturan`, `id_kriteria`, `kode_aturan`, `hasil`, `dibuat_oleh`, `waktu_dibuat`) VALUES
...
-- Dumping data for table rulebasetopsis.master_aturancustume: ~0 rows (approximately)
DELETE FROM `master_aturancustume`;
/*!40000 ALTER TABLE `master_aturancustume` DISABLE KEYS */;
INSERT INTO `master_aturancustume` (`id_aturancustume`, `keterangan`, `paramMax`) VALUES
...
DELETE FROM `master_aturandetail`;
/*!40000 ALTER TABLE `master_aturandetail` DISABLE KEYS */;
INSERT INTO `master_aturandetail` (`id_aturandetail`, `id_aturan`, `id_subkriteria`, `kondisi`, `nilai`, `dibuat_oleh`, `waktu_dibuat`) VALUES
...
-- Dumping data for table rulebasetopsis.master_divisi: ~24 rows (approximately)
DELETE FROM `master_divisi`;
/*!40000 ALTER TABLE `master_divisi` DISABLE KEYS */;
INSERT INTO `master_divisi` (`id_divisi`, `kode_divisi`, `nama_divisi`, `dibuat_oleh`, `waktu_dibuat`) VALUES
...
DELETE FROM `master_kriteria`;
/*!40000 ALTER TABLE `master_kriteria` DISABLE KEYS */;
INSERT INTO `master_kriteria` (`id_kriteria`, `kode_kriteria`, `nama_kriteria`, `bobot`, `tipe_kriteria`, `dibuat_oleh`, `waktu_dibuat`, `tahun_penilaian`) VALUES
	(1, 'KU', 'Kualitas', 20, 'Benefit', 1, '2019-11-01 21:16:23', '2018'),
	(2, 'PR', 'Profesional', 25, 'Benefit', 1, '2019-11-01 21:16:26', '2018'),
	(3, 'IN', 'Inovasi', 10, 'Benefit', 1, '2019-12-12 11:00:20', '2018'),
	(4, 'AN', 'Angka', 30, 'Benefit', 1, '2019-12-12 11:00:23', '2018'),
...
DELETE FROM `master_subkriteria`;
/*!40000 ALTER TABLE `master_subkriteria` DISABLE KEYS */;
INSERT INTO `master_subkriteria` (`id_subkriteria`, `kode_subkriteria`, `id_kriteria`, `keterangan`, `dibuat_oleh`, `waktu_dibuat`, `tipe_subkriteria`) VALUES
...
INSERT INTO `master_subkriteriadetail` (`id_subkriteriadetail`, `id_subkriteria`, `keterangan`, `nilai_akhir`, `nilai_awal`, `nilai_aktual`, `dibuat_oleh`, `waktu_dibuat`, `urutan_penilaian`) VALUES
...
DELETE FROM `param_matrik`;
/*!40000 ALTER TABLE `param_matrik` DISABLE KEYS */;
INSERT INTO `param_matrik` (`id_param_matrik`, `id_seleksi`, `id_kriteria`, `nilai`, `idealnegatif`, `idealpositif`, `dibuat_oleh`, `waktu_dibuat`) VALUES
	(11, 5, 1, 265.518, 2.26, 6.78, 7, '2019-12-12 11:01:27'),
	(12, 5, 2, 324.191, 2.3125, 7.7125, 7, '2019-12-12 11:01:27'),
	(13, 5, 3, 295.297, 0.677, 3.386, 7, '2019-12-12 11:01:27'),
	(14, 5, 4, 282.843, 2.121, 10.608, 7, '2019-12-12 11:01:27'),
	(15, 5, 5, 305.614, 0.981, 4.4175, 7, '2019-12-12 11:01:27');
...
-- Dumping data for table rulebasetopsis.pengguna: ~5 rows (approximately)
DELETE FROM `pengguna`;
/*!40000 ALTER TABLE `pengguna` DISABLE KEYS */;
INSERT INTO `pengguna` (`id_pengguna`, `nama_pengguna`, `id_divisi`, `username`, `password`, `rule`) VALUES
	(6, 'Admin', 1, 'admin', '81dc9bdb52d04dc20036dbd8313ed055', 5),
	(7, 'HRD Admin', 1, 'hrd', '81dc9bdb52d04dc20036dbd8313ed055', 1),
	(8, 'Kepala Divisi', 1, 'headdivisi', '81dc9bdb52d04dc20036dbd8313ed055', 2),
	(9, 'Direksi Tampan', 1, 'direksi', '81dc9bdb52d04dc20036dbd8313ed055', 4),
	(10, 'Karyawan A', 1, 'karyawan', '81dc9bdb52d04dc20036dbd8313ed055', 3);
...
INSERT INTO `penilaian` (`id_penilaian`, `id_divisi`, `dibuat_oleh`, `waktu_dibuat`, `tahun_penilaian`, `status`) VALUES
	(73, 1, 6, '2019-11-08 22:11:49', '2018', 'Finish'),
...
DELETE FROM `penilaian_detail`;
/*!40000 ALTER TABLE `penilaian_detail` DISABLE KEYS */;
INSERT INTO `penilaian_detail` (`id_penilaian_detail`, `id_penilaian`, `id_kriteria`, `id_subkriteria`, `id_subkriteriadetail`, `dibuat_oleh`, `waktu_dibuat`, `hasil`) VALUES
...
-- Dumping data for table rulebasetopsis.seleksi: ~0 rows (approximately)
DELETE FROM `seleksi`;
/*!40000 ALTER TABLE `seleksi` DISABLE KEYS */;
INSERT INTO `seleksi` (`id_seleksi`, `keterangan`, `dibuat_oleh`, `waktu_dibuat`, `tahun_penilaian`, `status_seleksi`, `status_keputusan`) VALUES
	(5, 'Seleksi dan Rangking Divisi', 6, '2019-12-12 11:01:27', '2018', 'Sudah diproses', 'Selesai');
...
DELETE FROM `seleksi_hasil`;
/*!40000 ALTER TABLE `seleksi_hasil` DISABLE KEYS */;
INSERT INTO `seleksi_hasil` (`id_seleksi_hasil`, `id_seleksi`, `id_divisi`, `dibuat_oleh`, `waktu_dibuat`, `hasil`, `apositif`, `anegatif`, `prefrensi`, `peringkat`, `ikeputusan`) VALUES
	(1, 5, 1, 6, '2019-11-08 21:08:42', 'Tidak Dilanjutkan', NULL, NULL, NULL, NULL, 0),
	(2, 5, 2, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 6.1429, 8.3637, 0.5765, 4, 1),
	(3, 5, 3, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 6.9951, 5.9357, 0.459, 13, 0),
	(4, 5, 4, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 5.2076, 8.4708, 0.6193, 3, 0),
	(5, 5, 5, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 7.8474, 6.364, 0.4478, 14, 0),
	(6, 5, 6, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 8.9212, 4.0613, 0.3128, 23, 0),
	(7, 5, 7, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 7.5435, 7.5844, 0.5014, 8, 0),
	(8, 5, 8, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 6.6228, 7.6477, 0.5359, 5, 0),
	(9, 5, 9, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 8.7402, 5.5766, 0.3895, 20, 0),
	(10, 5, 10, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 7.593, 6.643, 0.4666, 10, 0),
	(11, 5, 11, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 7.1082, 5.5274, 0.4374, 15, 0),
	(12, 5, 12, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 9.6349, 4.4104, 0.314, 22, 0),
	(13, 5, 13, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 8.6415, 5.4551, 0.387, 21, 0),
	(14, 5, 14, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 6.6077, 7.0723, 0.517, 7, 0),
	(15, 5, 15, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 6.3477, 6.967, 0.5233, 6, 0),
	(16, 5, 16, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 7.4144, 6.4136, 0.4638, 12, 0),
	(17, 5, 17, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 7.6861, 5.7604, 0.4284, 16, 0),
	(18, 5, 18, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 4.2795, 8.6036, 0.6678, 1, 1),
	(19, 5, 19, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 7.927, 6.8609, 0.464, 11, 0),
	(20, 5, 20, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 7.8648, 7.2879, 0.481, 9, 0),
	(21, 5, 21, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 8.1946, 5.7373, 0.4118, 17, 0),
	(22, 5, 22, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 5.2298, 9.1327, 0.6359, 2, 1),
	(23, 5, 23, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 8.5604, 5.7084, 0.4001, 19, 0),
	(24, 5, 24, 6, '2019-12-12 11:01:27', 'Dilanjutkan', 8.2198, 5.7407, 0.4112, 18, 0);
...
INSERT INTO `seleksi_hasildetail` (`id_seleksi_hasildetail`, `id_seleksi_hasil`, `id_kriteria`, `nilai_awal`, `nilai_normalisasi`, `nilai_terbobot`, `dibuat_oleh`, `waktu_dibuat`, `hasil`) VALUES
	...
	(8, 2, 3, 80, 0.2709, 2.709, 6, '2019-12-12 11:01:26', 'MS'),
	(9, 2, 4, 60, 0.2121, 6.363, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(13, 3, 3, 60, 0.2032, 2.032, 6, '2019-12-12 11:01:26', 'MS'),
	(14, 3, 4, 100, 0.3536, 10.608, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(18, 4, 3, 100, 0.3386, 3.386, 6, '2019-12-12 11:01:26', 'MS'),
	(19, 4, 4, 50, 0.1768, 5.304, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(23, 5, 3, 20, 0.0677, 0.677, 6, '2019-12-12 11:01:26', 'TMS'),
	(24, 5, 4, 40, 0.1414, 4.242, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(28, 6, 3, 40, 0.1355, 1.355, 6, '2019-12-12 11:01:26', 'MS'),
	(29, 6, 4, 20, 0.0707, 2.121, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(33, 7, 3, 40, 0.1355, 1.355, 6, '2019-12-12 11:01:26', 'MS'),
	(34, 7, 4, 80, 0.2828, 8.484, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(38, 8, 3, 40, 0.1355, 1.355, 6, '2019-12-12 11:01:26', 'MS'),
	(39, 8, 4, 60, 0.2121, 6.363, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(43, 9, 3, 60, 0.2032, 2.032, 6, '2019-12-12 11:01:26', 'MS'),
	(44, 9, 4, 50, 0.1768, 5.304, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(48, 10, 3, 20, 0.0677, 0.677, 6, '2019-12-12 11:01:26', 'TMS'),
	(49, 10, 4, 70, 0.2475, 7.425, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(53, 11, 3, 20, 0.0677, 0.677, 6, '2019-12-12 11:01:26', 'TMS'),
	(54, 11, 4, 80, 0.2828, 8.484, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(58, 12, 3, 20, 0.0677, 0.677, 6, '2019-12-12 11:01:27', 'TMS'),
	(59, 12, 4, 30, 0.1061, 3.183, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(63, 13, 3, 40, 0.1355, 1.355, 6, '2019-12-12 11:01:27', 'MS'),
	(64, 13, 4, 80, 0.2828, 8.484, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(68, 14, 3, 20, 0.0677, 0.677, 6, '2019-12-12 11:01:27', 'TMS'),
	(69, 14, 4, 70, 0.2475, 7.425, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(73, 15, 3, 20, 0.0677, 0.677, 6, '2019-12-12 11:01:27', 'TMS'),
	(74, 15, 4, 60, 0.2121, 6.363, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(78, 16, 3, 100, 0.3386, 3.386, 6, '2019-12-12 11:01:27', 'MS'),
	(79, 16, 4, 50, 0.1768, 5.304, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(83, 17, 3, 20, 0.0677, 0.677, 6, '2019-12-12 11:01:27', 'TMS'),
	(84, 17, 4, 80, 0.2828, 8.484, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(88, 18, 3, 100, 0.3386, 3.386, 6, '2019-12-12 11:01:27', 'MS'),
	(89, 18, 4, 40, 0.1414, 4.242, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(93, 19, 3, 80, 0.2709, 2.709, 6, '2019-12-12 11:01:27', 'MS'),
	(94, 19, 4, 30, 0.1061, 3.183, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(98, 20, 3, 40, 0.1355, 1.355, 6, '2019-12-12 11:01:27', 'MS'),
	(99, 20, 4, 60, 0.2121, 6.363, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(103, 21, 3, 80, 0.2709, 2.709, 6, '2019-12-12 11:01:27', 'MS'),
	(104, 21, 4, 20, 0.0707, 2.121, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(108, 22, 3, 100, 0.3386, 3.386, 6, '2019-12-12 11:01:27', 'MS'),
	(109, 22, 4, 70, 0.2475, 7.425, 6, '2019-12-12 11:01:27', 'MS'),
	...
	(113, 23, 3, 60, 0.2032, 2.032, 6, '2019-12-12 11:01:27', 'MS'),
	(114, 23, 4, 40, 0.1414, 4.242, 6, '2019-12-12 11:01:27', 'TMS'),
	...
	(118, 24, 3, 80, 0.2709, 2.709, 6, '2019-12-12 11:01:27', 'MS'),
	(119, 24, 4, 20, 0.0707, 2.121, 6, '2019-12-12 11:01:27', 'TMS'),
